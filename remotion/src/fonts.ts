...
export const TITLE_FONT = `${SPACE_MONO}, 'Courier New', monospace`;
export const HAND_FONT = `${CAVEAT}, cursive`;

/** Кандидаты для titleFont (оверлеи): ключ → font-family.
 *  Боевой дефолт = mono (выбор yaromat 2026-09-11 на пробе в фактори).
 *  Ключи перечислены в порядке проб. */
