...
MOTIONS     = {"static", "slow_push", "zoom_in", "zoom_out", "drift", "handheld", "tilt", "pan"}
...
ENERGY_MOTIONS = {
    ...
    "medium": ["drift", "zoom_in", "tilt", "slow_push", "pan"],
...
- motion: static|slow_push|zoom_in|zoom_out|drift|handheld|tilt|pan — ОРГАНИЧНАЯ камера (не вектор).
